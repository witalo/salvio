...
class NutritionLaw(models.Model):
    ...
    n = models.DecimalField('N', max_digits=20, decimal_places=4, default=0)
    p2o5 = models.DecimalField('P2O5', max_digits=20, decimal_places=4, default=0)
    k2o = models.DecimalField('K2O', max_digits=20, decimal_places=4, default=0)
    cao = models.DecimalField('CAO', max_digits=20, decimal_places=4, default=0)
    mgo = models.DecimalField('MGO', max_digits=20, decimal_places=4, default=0)
    s = models.DecimalField('S', max_digits=20, decimal_places=4, default=0)
    fe = models.DecimalField('FE', max_digits=20, decimal_places=4, default=0)
    mn = models.DecimalField('MN', max_digits=20, decimal_places=4, default=0)
    b = models.DecimalField('B', max_digits=20, decimal_places=4, default=0)
    zn = models.DecimalField('ZN', max_digits=20, decimal_places=4, default=0)
    mo = models.DecimalField('MO', max_digits=20, decimal_places=4, default=0)
    ci = models.DecimalField('CI', max_digits=20, decimal_places=4, default=0)
    cu = models.DecimalField('CU', max_digits=20, decimal_places=4, default=0)
    h2o = models.DecimalField('H2O', max_digits=20, decimal_places=4, default=0)
    user = models.ForeignKey(User, verbose_name='Usuario', on_delete=models.SET_NULL, null=True, blank=True)
    create_at = models.DateTimeField(auto_now=True)
